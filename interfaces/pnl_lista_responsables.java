...
public class pnl_lista_responsables extends javax.swing.JPanel {
	...
	private void initGUI() {
		try {
			...
			this.setMinimumSize(new java.awt.Dimension(410, 175));
			{
				...
				this.add(lst_responsables, new AnchorConstraint(25, 15, 48, 15,
				...
				lst_responsables.setPreferredSize(new java.awt.Dimension(380,
						92));
			}
			{
				pnl_botones_lst_resp = new JPanel();
				this.add(pnl_botones_lst_resp, new AnchorConstraint(800, 13, 5,
						17, AnchorConstraint.ANCHOR_NONE,
						AnchorConstraint.ANCHOR_ABS,
						AnchorConstraint.ANCHOR_ABS,
						AnchorConstraint.ANCHOR_ABS));
				...
				pnl_botones_lst_resp.setPreferredSize(new java.awt.Dimension(
						380, 37));
				{
					btn_agregar_resp = new JButton();
					pnl_botones_lst_resp.add(btn_agregar_resp);
					btn_agregar_resp.setText("Agregar Responsable");
					btn_agregar_resp.setPreferredSize(new java.awt.Dimension(
							172, 26));
				...
				}
				{
					...
					btn_quitar_resp.setPreferredSize(new java.awt.Dimension(
							172, 26));
	...
	public void setearCreacion() {
		((DefaultListModel) lst_responsables.getModel()).removeAllElements();
	...
	public void setearModificacion(Actividad act) {
		...
		for (i = 0; i < act.cant_Responsables(); i++) {
			agregar_a_lista(act.getResponsable(i));
		}
	}
	...
	public void mostrarLista() {
		...
		for (int i = 0; i < cant; i++) {
			modelo
					.addElement(((Persona) lista_responsables.get(i))
							.getNombre());
		}
	...
	private void btn_agregar_respActionPerformed(ActionEvent evt) {
		...
		dlg_reg_resp dlg_responsables = new dlg_reg_resp(this,Parent);
	...
	private void btn_quitar_respActionPerformed(ActionEvent evt) {
		...
		if (i == -1) {
			JOptionPane.showMessageDialog(null,
					"Seleccione un responsable de la lista");
		} else {
